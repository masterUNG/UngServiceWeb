...
import 'package:ungserviceweb/utility/my_dialog.dart';
import 'package:ungserviceweb/widgets/show_button.dart';
import 'package:ungserviceweb/widgets/show_form.dart';
...
class _TakePhotoState extends State<TakePhoto> {
  ...
  Future<void> processUpload() async {
    String pathApiUpload =
        'https://www.androidthai.in.th/egat/saveImageUng.php';
    String nameImage = 'ung${Random().nextInt(10000000)}.jpg';
    ...
    await Dio().post(pathApiUpload, data: formData).then((value) async {
      ...
      String pathApiInsertData =
          'https://www.androidthai.in.th/egat/insertImageUng.php?isAdd=true&title=$title&urlImage=$urlImage';
      await Dio().get(pathApiInsertData).then((value) {
        MyDialog(context: context).normalDialog(
            title: 'Upload and Insert Success',
            subTitle: 'Success to Upload and Insert');
      });
    });
  }
}
