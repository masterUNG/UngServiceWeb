...
import 'package:ungserviceweb/models/photo_model.dart';
import 'package:ungserviceweb/utility/my_constant.dart';
import 'package:ungserviceweb/widgets/show_progress.dart';
...
class _ListPhotoState extends State<ListPhoto> {
  ...
  Future<void> readAllPhoto() async {
    String pathAPI = 'https://www.androidthai.in.th/egat/getAllPhotoUng.php';
